...
class TrainModel():
    ...
    def __init__(self, dataset, method, input_size, c_kernels=[7, 5], out_channels=[30, 16], in_channels=[3, 30], p_kernel=[2, 2], p_stride=[2, 2], apt=0, dataset_name="intel", epoch=200):
    ...
    def training(self):
        ...
        for e in range(self.epoch):
           ...
           # pass through all data
            ...
            self.cnn_model, self.optimizer = adaptive_leraning_rate(loss_train[-1], self.optimizer, self.cnn_model, self.old_param, old_loss)
